...
Once you are there, let’s see what we’re working with. To look at what is in the directory type the following code: <code>dir</code>

{% include imgwithcaption.html filepath="/assets/img/CLWin3.JPG" alt="Directory of C:\Users\spurcell" caption="Starting with spurcell's user folder" %}
...
{% include imgwithcaption.html filepath="/assets/img/CLWin4.JPG" alt="Text files in  C:\Users\spurcell\Downloads\command prompt directory" caption="28 txt files in the command prompt folder" %}
...
While you are in the command prompt directory type in: <code> find /c “tuberculosis” * </code>

You will get this output:  

{% include imgwithcaption.html filepath="/assets/img/CLWin5.JPG" alt="Returned term count for searching 'tuberculosis' in all files in the directory" caption="Our command returned 22 instances of tuberculosis in the files"  %}
...
{% include imgwithcaption.html filepath="/assets/img/CLWin6.JPG" alt="Returns the apprearance count for the term 'tuberculosis' for each file as a result of: C:\Users\spurcell\Downloads\command prompt > find /c 'tuberculosis' *" caption="Solution for tuberculosis term count command" %}
