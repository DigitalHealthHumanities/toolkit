...
<img src="{{ site.baseurl}}/assets/img/CLVoy2.jpg" class="example-img" alt="line graph for the document terms - 'died' and 'day' have the highest relative frequencies, with 'died' peaking at about 0.0047 for 7 document segments, and 'day' peaking at about 0.0035 for 6 document segments. No other term exceeds 0.0020." />
...
<img src="{{ site.baseurl }}/assets/img/CLVoy6.jpg" class="example-img" alt="Word Cloud - most common words are died, day, tuberculous, meningitis, tuberculosis. File name 'theamericanreviewoftuberc11_1925' is also present." />
...
<img src="{{ site.baseurl }}/assets/img/CLVoy7.jpg" class="example-img" alt="Entire Text Collection word cloud. Most popular words include: tuberculous, treatment, disease, cases."/>
